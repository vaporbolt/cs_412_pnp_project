...
do
  ...
  cat exact_solution/test_cases/10_vertex.txt | python approximation_solution/cs412_tsp_approx.py >> output_approx.txt
...
do
  ...
  cat exact_solution/test_cases/11_vertex.txt | python approximation_solution/cs412_tsp_approx.py >> output_approx.txt
...
do
  ...
  cat exact_solution/test_cases/12_vertex.txt | python approximation_solution/cs412_tsp_approx.py >> output_approx.txt
...
do
  ...
  cat exact_solution/test_cases/13_vertex.txt | python approximation_solution/cs412_tsp_approx.py >> output_approx.txt
...
do
  ...
  cat exact_solution/test_cases/30_vertex.txt | python approximation_solution/cs412_tsp_approx.py >> output_approx.txt
...
do
  ...
  cat exact_solution/test_cases/provided_1.txt | python approximation_solution/cs412_tsp_approx.py >> output_approx.txt
...
do
  ...
  cat exact_solution/test_cases/provided_2.txt | python approximation_solution/cs412_tsp_approx.py >> output_approx.txt
